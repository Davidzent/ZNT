 ...
 */
const getTokens = (html5player, options) => exports.cache.getOrSet(html5player, async () => {
    const body = await html_fetch.fetch('GET', html5player)
    const tokens = extractActions(body);
    if (!tokens || !tokens.length) {
        throw Error('Could not extract signature deciphering actions');
    }
    exports.cache.set(html5player, tokens);
    return tokens;
});
 ...
 * @param {Object} options
 */
exports.Formats = async (formats, html5player, options) => {
