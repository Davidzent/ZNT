 ...
 * find JSON
 *
 * @param {string} source   debug variable
 * @param {string} varName  debug variable
 * @param {string} body     html request string
 * @param {string} left     left corner for between
 * @param {string} right    righ corner
 * @param {string} prependJSON  end
 * @return {Object}
 */
