 ...
 * Created on April 19th, 2018, 3:22 PM
...
class LinkedList{
    ...
    public:
        ...
        void  addLst(const T&,long long int&);  //Add data at the end of the list
...
template<class T>
void LinkedList<T>::addLst(const T &data,long long int& op){
