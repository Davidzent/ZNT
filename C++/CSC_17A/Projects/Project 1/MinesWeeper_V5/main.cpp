...
void reveal0(Map *strct,char **hide,char x,int y,int){
    //corners
    //left upper
    if(strct->map[x][y]=='0'&&x==0&&y==0){
        for(int i=y;i<=y+1;i++){
            for(int j=x;j<=x+1;j++){
    ...
    //right bottom
    else if(strct->map[x][y]=='0'&&x==9&&y==9){
        for(int i=y-1;i<=y;i++){
            for(int j=x-1;j<=x;j++){
                if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
            }
    ...
    //right upper
    else if(strct->map[x][y]=='0'&&x==0&&y==9){
        for(int i=y-1;i<=y;i++){
            for(int j=x;j<=x+1;j++){
                if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
            }
    ...
    //left bottom
    else if(strct->map[x][y]=='0'&&x==9&&y==0){
        for(int i=y;i<=y+1;i++){
            for(int j=x-1;j<=x;j++){
                if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
            }
    ...
    //center
    else if(strct->map[x][y]=='0'&&x>0&&y>0&&x<9&&y<9){
    ...
    //upper center row
    else if(strct->map[x][y]=='0'&&x>0&&x<9&&y==0){
        for(int i=y;i<=y+1;i++){
            for(int j=x-1;j<=x+1;j++){
                if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
            }
    ...
    //bottom center row
    else if(strct->map[x][y]=='0'&&x>0&&x<9&&y==9){
        for(int i=y-1;i<=y;i++){
            for(int j=x-1;j<=x+1;j++){
                if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
            }
    ...
    //left center column
    else if(strct->map[x][y]=='0'&&y>0&&y<9&&x==0){
        for(int i=y-1;i<=y+1;i++){
            for(int j=x;j<=x+1;j++){
                if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
            }
    ...
    //right center column
    else if(strct->map[x][y]=='0'&&y>0&&y<9&&x==9){
        for(int i=y-1;i<=y+1;i++){
            for(int j=x-1;j<=x;j++){
                if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
            }
