...
void reveal0(Map *strct,char **hide,char x,int y){
    int cntx=x;
    int cnty=y;
    //while(strct->map[cnty][cntx]=='0'){
        //corners
        //upper left corner
        if(strct->map[cnty][cntx]=='0'&&cntx==0&&cnty==0){
            for(int i=cnty;i<=cnty+1;i++){
                for(int j=cntx;j<=cntx+1;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
            }
        }
        //bottom right corner
        else if(strct->map[cnty][cntx]=='0'&&cntx==9&&cnty==9){
            for(int i=cnty-1;i<=cnty;i++){
                for(int j=cntx-1;j<=cntx;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
            }
        }
        //upper right corner
        else if(strct->map[cnty][cntx]=='0'&&cntx==0&&cnty==9){
            for(int i=cnty-1;i<=cnty;i++){
                for(int j=cntx;j<=cntx+1;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
        ...
        //bottom left corner
        else if(strct->map[cnty][cntx]=='0'&&cntx==9&&cnty==0){
            for(int i=cnty;i<=cnty+1;i++){
                for(int j=cntx-1;j<=cntx;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
        ...
        //center
        else if(strct->map[cnty][cntx]=='0'&&cntx>0&&cnty>0&&cntx<9&&cnty<9){
            for(int i=cnty-1;i<=cnty+1;i++){
                for(int j=cntx-1;j<=cntx+1;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
            }
        }
        //upper center row
        else if(strct->map[cnty][cntx]=='0'&&cntx>0&&cntx<9&&cnty==0){
            for(int i=cnty;i<=cnty+1;i++){
                for(int j=cntx-1;j<=cntx+1;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
        ...
        //bottom center row
        else if(strct->map[cnty][cntx]=='0'&&cntx>0&&cntx<9&&cnty==9){
            for(int i=cnty-1;i<=cnty;i++){
                for(int j=cntx-1;j<=cntx+1;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
        ...
        //left center column
        else if(strct->map[cnty][cntx]=='0'&&cnty>0&&cnty<9&&cntx==0){
            for(int i=cnty-1;i<=cnty+1;i++){
                for(int j=cntx;j<=cntx+1;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
        ...
        //right center column
        else if(strct->map[cnty][cntx]=='0'&&cnty>0&&cnty<9&&cntx==9){
            for(int i=cnty-1;i<=cnty+1;i++){
                for(int j=cntx-1;j<=cntx;j++){
                    if(strct->map[i][j]!='X')reveal(strct,hide,j,i);
                }
        ...
        /*if(strct->map[cntx+1][cnty]=='0')cntx++;
        else cnty++;
        if(cntx==strct->col)cnty++;
        if(cnty==strct->row)break;*/
    //}
}
void destroy(Map *d2){
